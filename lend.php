...
$sql = "SELECT c.*, p.* FROM books c, student p WHERE c.book_id = p.book_id AND sdept='$i'";

$result = mysqli_query($con, $sql)or die(mysqli_error());

echo "<table align='center' border = 1>";
echo "<caption style='text-align:center'><b>Category of ".$i."</b></caption>";
echo "<tr><th style='text-align:center' width='5%'>Bookname</th><th style='text-align:center' width='5%'>Writer</th><th style='text-align:center' width='5%'>Borrower Name</th><th style='text-align:center' width='5%'>Department</th><th style='text-align:center' width='5%'>Class Roll</th><th style='text-align:center' width='5%'>Borrowed Date</th><th style='text-align:center' width='5%'>Bepaid Date</th><th style='text-align:center' width='5%'>Bepaid Remove</th></tr>";
